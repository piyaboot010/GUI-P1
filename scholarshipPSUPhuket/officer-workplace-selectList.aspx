<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="officer-workplace-selectList.aspx.cs" Inherits="scholarshipPSUPhuket.officer_workpace_selectList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 5.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>รายชื่อนักศึกษาที่เลือกสถานที่ทำงาน</title>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1"/>
    <link rel="stylesheet" href="https://www.w3schools.com/lib/w3.css"/>
</head>
<body>
    <form id="OfficerWorkPlaceSelectNameList" runat="server">
    <!-- Header -->
    <div class="w3-row">
        ...
        <div class="w3-col w3-white w3-container" style="width:60%">
            ...
            <div class="w3-container">
                <div class="w3-container w3-lime w3-center">
                    <h3>รายชื่อนักศึกษาที่เลือกสถานที่ทำงาน</h3>
                </div>
                  <div class="w3-container w3-center">
                    <iframe src="https://docs.google.com/spreadsheets/d/1xhYG2Bv3FovUop0QT9FolDDghCVIHpZ34alRntdzxjk/pubhtml?gid=0&amp;single=true&amp;widget=true&amp;headers=false&amp;chrome=false" height="400" width="980"></iframe>
                  </div> 
            </div>
