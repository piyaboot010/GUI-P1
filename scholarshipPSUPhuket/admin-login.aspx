<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin-login.aspx.cs" Inherits="scholarshipPSUPhuket.admin_login" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 5.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Admin เข้าสู่ระบบ</title>
    <meta charset="utf-8" />
        ...
        <div class="w3-col w3-white w3-container" style="width:20%">
            ...
            <div class="w3-card-4">
                <div class="w3-container w3-lime w3-center">
                    ...
                    <br/>
                        <asp:Label ID="adminidT" class="w3-label w3-text-lime" runat="server" Text="PSU Passport"></asp:Label>
                        <asp:TextBox ID="adminid" class="w3-input w3-border w3-sand" runat="server"></asp:TextBox>
                    <br/>
                        <asp:Label ID="adminpwdT" class="w3-label w3-text-lime" runat="server" Text="Password"></asp:Label>
                        <asp:TextBox ID="adminpwd" class="w3-input w3-border w3-sand" type="password" runat="server"></asp:TextBox>
                    <br/>
                        <asp:Button ID="adminlogin" runat="server" class="w3-button w3-lime w3-center" Text="Login" OnClick="adminlogin_Click" />
                    <br/><br/>
                    </div>
            </div>
