<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="officer-sch-namelist.aspx.cs" Inherits="scholarshipPSUPhuket.office_sch_namelist" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 5.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>รายชื่อนักศึกษาที่สมัครทุน</title>
    <meta charset="utf-8" />
...
<body>
    <form id="officerSchNamelist" runat="server">
    <!-- Header -->
    <div class="w3-row">
        ...
        <%--<div class="w3-col w3-white w3-container" style="width:70%">--%>
            ...
            <div class="w3-container">
                <div class="w3-container w3-lime w3-center">
                    <h4>รายการขอนักศึกษาช่วยงานทั้งหมด</h4>
                </div>
                  <div class="w3-container w3-center">
                    <iframe src="https://docs.google.com/spreadsheets/d/1FkPULKlSTPDxhZfKI9Hcu454gMlHQWTCDWerLoZyOIs/edit?usp=sharing;headers=false&amp;chrome=false" height="500" width="1800"></iframe>
                  </div> 
            </div>
