<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="std-out-scholarship.aspx.cs" Inherits="scholarshipPSUPhuket.std_out_scholarship" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 5.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>ทุนภายนอก</title>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1"/>
    <link rel="stylesheet" href="https://www.w3schools.com/lib/w3.css"/>
</head>
<body>
    <form id="stdoutsholarship" runat="server">
    <!-- Header -->
    <div class="w3-row">
    ...
    <div class="w3-row">
        ...
        <div class="w3-col w3-white w3-container" style="width:60%">
            ...
            <div class="w3-container" style="height:600px;">
                    ...
                    <!-- <embed src="pdf/UGRAD2017.pdf" width="800px" height="2100px" /> -->
                    <iframe src="pdf/UGRAD2017.pdf" style="width:100%; height:100%; border: none;"></iframe>
